...
*/
class NextbikeArth_Goldau__LV_ extends BikeHireFeeder
{
  ...
  static function name() {
    return 'arth_goldau__lv_-nextbike';
  }
  ...
  static function description() {
    return "Nextbike Arth-Goldau (LV)";
  }
  ...
  function update() {
    ...
    foreach ($cities as $city) {
      if($city->getAttribute('name') == "Arth-Goldau (LV)") {
