...
*/
class NextbikeOffenbach_am_Main extends BikeHireFeeder
{
  ...
  static function name() {
    return 'offenbach_am_main-nextbike';
  }
  ...
  static function description() {
    return "Nextbike Offenbach am Main";
  }
  ...
  function update() {
    ...
    foreach ($cities as $city) {
      if($city->getAttribute('name') == "Offenbach am Main") {
