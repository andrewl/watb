...
*/
class NextbikeFriedrichshafen extends BikeHireFeeder
{
  ...
  static function name() {
    return 'friedrichshafen-nextbike';
  }
  ...
  static function description() {
    return "Nextbike Friedrichshafen";
  }
  ...
  function update() {
    ...
    foreach ($cities as $city) {
      if($city->getAttribute('name') == "Friedrichshafen") {
