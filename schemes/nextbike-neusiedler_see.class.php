...
*/
class NextbikeNeusiedler_See extends BikeHireFeeder
{
  ...
  static function name() {
    return 'neusiedler_see-nextbike';
  }
  ...
  static function description() {
    return "Nextbike Neusiedler See";
  }
  ...
  function update() {
    ...
    foreach ($cities as $city) {
      if($city->getAttribute('name') == "Neusiedler See") {
