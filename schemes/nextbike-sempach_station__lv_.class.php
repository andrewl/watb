...
*/
class NextbikeSempach_Station__LV_ extends BikeHireFeeder
{
  ...
  static function name() {
    return 'sempach_station__lv_-nextbike';
  }
  ...
  static function description() {
    return "Nextbike Sempach Station (LV)";
  }
  ...
  function update() {
    ...
    foreach ($cities as $city) {
      if($city->getAttribute('name') == "Sempach Station (LV)") {
