...
*/
class NextbikeWiener_Neustadt extends BikeHireFeeder
{
  ...
  static function name() {
    return 'wiener_neustadt-nextbike';
  }
  ...
  static function description() {
    return "Nextbike Wiener Neustadt";
  }
  ...
  function update() {
    ...
    foreach ($cities as $city) {
      if($city->getAttribute('name') == "Wiener Neustadt") {
