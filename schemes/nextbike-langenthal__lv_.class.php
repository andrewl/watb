...
*/
class NextbikeLangenthal__LV_ extends BikeHireFeeder
{
  ...
  static function name() {
    return 'langenthal__lv_-nextbike';
  }
  ...
  function update() {
    ...
    foreach ($cities as $city) {
      if($city->getAttribute('name') == "Langenthal (LV)") {
